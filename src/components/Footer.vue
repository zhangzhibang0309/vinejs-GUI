<template>
  <footer
    class="px-3 py-8 bg-green-100 dark:bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200"
  >
    <div class="flex flex-col">
      ...
      <div class="mt-4 md:mt-0 flex flex-col md:flex-row">
        ...
        >
          <a
            aria-current="page"
            href="https://github.com/ShawnZhou2000/vinejs-GUI/issues"
            target="_blank"
            class="hover:text-gray-700 mb-2 dark:hover:text-white"
          >
            Bug 反馈
          </a>
          <a
          ...
          >
            Vine.js Guider Version 0.0.1

            <span
              class="px-2 text-small rounded-full text-white bg-red-600 font-light"
            >
              beta
            </span>
          </a>
        ...
        >
          <a
            ...
            href="https://github.com/ShawnZhou2000/vinejs-GUI"
          >
            ...
            <svg
              ...
              height="30"
              fill="currentColor"
              class="text-xl hover:text-gray-800 dark:hover:text-white gray-300 transition-colors duration-200"
        ...
        >
          ...
          <span class="mt-7 md:mt-1">
            ...
            <a
              ...
              href="https://github.com/ShawnZhou2000/"
              target="_blank"
            >
              Shawn Zhou
            </a>
